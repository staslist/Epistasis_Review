...
agmat(bed_file, home_dir + 'add_genom_rel_matrix_dd_pure_mult_twopairs_interalpha2') 
dgmat_as(bed_file, home_dir + 'dom_genom_rel_matrix_dd_pure_mult_twopairs_interalpha2')

# Step 2: Estimate the variances
add_genom_rel_matrix = home_dir + 'add_genom_rel_matrix_dd_pure_mult_twopairs_interalpha2.agrm.mat_fmt'
dom_genom_rel_matrix = home_dir + 'dom_genom_rel_matrix_dd_pure_mult_twopairs_interalpha2.dgrm_as.mat_fmt'
...
wemai_multi_gmat(pheno_file, bed_file, gmat_lst, out_file= home_dir + 'var_dd_pure_mult_twopairs_interalpha2.txt')


# Step 3: Test
var_com = np.loadtxt(home_dir + 'var_dd_pure_mult_twopairs_interalpha2.txt')  # numpy array： [0] addtive variance; [1] additive by additive variance; [2] residual variance
remma_epiDD(pheno_file, bed_file, gmat_lst, var_com, p_cut=1.0e-5, out_file=home_dir + 'epiDD_dd_pure_mult_twopairs_interalpha2')


# Step 4: Select top SNPs and add the SNP position
res_file = home_dir + 'epiDD_dd_pure_mult_twopairs_interalpha2'  # result file
